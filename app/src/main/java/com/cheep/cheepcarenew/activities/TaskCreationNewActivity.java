 ...
 */
public class TaskCreationNewActivity extends BaseAppCompatActivity {
    private static final String TAG = TaskCreationNewActivity.class.getSimpleName();
    ...
    public static void getInstance(Context mContext, JobCategoryModel model) {
        Intent intent = new Intent(mContext, TaskCreationNewActivity.class);
            ...
            public void onClick(View v) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        setTaskState(TaskCreationNewActivity.STEP_ONE_VERIFIED);
                        gotoStep(TaskCreationNewActivity.STAGE_2);
                    }
                }, 500);
...
//        Log.d(TAG, "gpsEnabled() called");
    ...
    public void onLocationSettingsDialogNeedToBeShow(Status locationRequest) {
        ...
        try {
            ...
            locationRequest.startResolutionForResult(TaskCreationNewActivity.this, Utility.REQUEST_CODE_CHECK_LOCATION_SETTINGS);
        } catch (Exception e) {
            // Ignore the error.
        }
    }
...
//                    model.taskImage = mTaskCreationPagerAdapter.mEnterTaskDetailFragment.mCurrentPhotoPath;
        ...
        BookingConfirmationInstaActivity.newInstance(TaskCreationNewActivity.this, taskDetailModel, mTaskCreationPagerAdapter.mEnterTaskDetailFragment.mSelectedAddressModel);
    }
...
//                onInstaBookClicked();
    ...
    private final MediaFullScreenAdapter.MediaInteractionListener mediaInteractionListener = new MediaFullScreenAdapter.MediaInteractionListener() {
        ...
        public void onRemoveClick(int position, MediaModel model) {
            ...
            mediaFullScreenAdapter.removeItem(TaskCreationNewActivity.this, position, model);
