...
import com.cheep.R;
import com.cheep.databinding.RowAddressOptionItemBinding;
...
public class AddressOptionsRecyclerViewAdapter extends RecyclerView.Adapter<AddressOptionsRecyclerViewAdapter.ViewHolder> {

    private ArrayList<AddressModel> mList;
    private String selected = "";
    private RadioButton selectedRadioBtn;

    public AddressOptionsRecyclerViewAdapter(ArrayList<AddressModel> mList) {
        if (mList != null)
            this.mList = mList;
        else
    ...
    @Override
    public AddressOptionsRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        RowAddressOptionItemBinding mRowAddressBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.row_address_option_item, parent, false);
        return new AddressOptionsRecyclerViewAdapter.ViewHolder(mRowAddressBinding);
    }

    @Override
    public void onBindViewHolder(final AddressOptionsRecyclerViewAdapter.ViewHolder holder, int position) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public final RowAddressOptionItemBinding mRowAddressBinding;

        public ViewHolder(RowAddressOptionItemBinding binding) {
