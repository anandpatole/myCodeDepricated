...
public class PackageBundlingFragment extends BaseFragment {
    ...
    public PackageBundlingFragment() {
    ...
    public PackageBundlingFragment(SubscriptionBannerModel bannerModel) {
        // Required empty public constructor
        this.bannerImageModel = bannerModel;
    }

    public static PackageBundlingFragment getInstance(SubscriptionBannerModel bannerModel) {
        return new PackageBundlingFragment(bannerModel);
    }
