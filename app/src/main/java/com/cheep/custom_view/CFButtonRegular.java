 ...
 */
public class CFButtonRegular extends AppCompatButton {

    private Context mContext;

    public CFButtonRegular(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
        init(attrs, defStyle);
    }

    public CFButtonRegular(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs, 0);
    }

    public CFButtonRegular(Context context) {
        super(context);
        mContext = context;
        init();
    }
