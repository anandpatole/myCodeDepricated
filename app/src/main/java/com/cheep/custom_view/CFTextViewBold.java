 ...
 */
public class CFTextViewBold extends android.support.v7.widget.AppCompatTextView {

    private Context mContext;

    public CFTextViewBold(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mContext = context;
        init(attrs, defStyle);
    }

    public CFTextViewBold(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init(attrs, 0);
    }
    ...
    private void init() {
        setTypeface(TypeFaceProvider.get(mContext, getResources().getString(R.string.font_bold)));
    }
