...
//        text.setText(txt);
        ...
        switch (gravity) {
            case Gravity.LEFT:
                ...
                container.addView(contentView, new LinearLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, LinearLayout.LayoutParams.WRAP_CONTENT));
    ...
    public boolean onPreDraw() {
        ...
        int textWidth = contentView.getWidth();
        int textHeight = contentView.getHeight();
