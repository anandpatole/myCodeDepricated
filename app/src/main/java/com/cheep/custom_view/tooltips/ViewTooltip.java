...
public class ViewTooltip {
    ...
    public TooltipView getTooltip_view() {
        return tooltip_view;
    }
    ...
    public ViewTooltip customView(View customView, boolean delay) {
        this.tooltip_view.setCustomView(customView, delay);
        return this;
    }

   /* public ViewTooltip customView(int viewId) {
        this.tooltip_view.setCustomView(((Activity) view.getContext()).findViewById(viewId), delay);
        return this;
    }*/
...
//            childView.setPadding(0, 0, 0, 0);
        ...
        public void setCustomView(View customView, boolean delay) {
            this.removeAllViews();
            ...
            if (delay)
                view.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        addView(childView, view.getWidth(), ViewGroup.LayoutParams.WRAP_CONTENT);
                    }
                }, 200);
            else
                addView(childView, view.getWidth(), ViewGroup.LayoutParams.WRAP_CONTENT);
