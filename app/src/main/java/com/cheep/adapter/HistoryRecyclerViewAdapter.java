...
//        Utility.showCircularImageView(holder.mRowHistoryBinding.imgProfile.getContext(), TAG, holder.mRowHistoryBinding.imgProfile, model.sp_profile_image, 0);
        ...
        holder.mRowHistoryBinding.textSpent.setText(mContext.getString(R.string.ruppe_symbol_x_space, model.paid_amount));
        holder.mRowHistoryBinding.textSaved.setText(mContext.getString(R.string.ruppe_symbol_x_space, model.saved_amount));
